...
#define DOWN_EDGE 64   //图像下边沿的像素点个数
#define UP_EDGE   16   //在与图像下边沿所表示的等长的距离在图形上边沿所占的像素点个数  16
/*图像的使用距离，计算误差用的*/
#define MIX_distance  15//最近的距离  15
...
#define dj_center 5120 //舵机中心值   3745   3670
#define DJ_DIFF 700   //最大打角与中心值的差值
...
#define MOTOR3_PWM  FTM_CH2//通道4 PTA5
#define MOTOR4_PWM  FTM_CH3//通道3 PTA6
