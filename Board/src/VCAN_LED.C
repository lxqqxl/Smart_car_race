...
void led_turn(LED_e ledn)
{
 ...
 #define OLED_SCL  PTD15_OUT
  #define OLED_SDA  PTD14_OUT
  #define OLED_RST  PTD13_OUT
  #define OLED_DC   PTE2_OUT
  #define OLED_CS   PTD12_OUT
...
void OLED_Init(void)
{
         ...
         gpio_init (PTD14, GPO,HIGH);
         gpio_init (PTE2, GPO,HIGH);
         gpio_init (PTD12, GPO,HIGH);
         gpio_init (PTD13, GPO,LOW);
...
void OLED_DrawPoint(uint8 y,uint8 x,uint8 mode)
{
